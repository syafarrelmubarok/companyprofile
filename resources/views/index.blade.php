...
<body>
    ...
    <div class="medsos">
        <div class="container">
            <ul>
                <li><a href="https://www.facebook.com/SyafarrelMubarok"><i class="fa-brands fa-facebook"></i></a></li>
                <li><a href="https://instagram.com/syafarelll___?igshid=YmMyMTA2M2Y="><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="https://wa.me//6281337686602"><i class="fa-brands fa-whatsapp"></i></a></li>
            </ul>
        </div>
    </div>
    <header>
        <div class="container">
            <h1><a href="index.html">SYAFARREL</a></h1>
            <ul>
    ...
    <footer>
        <div class="container">
            <small>Copyright &copy; 2022 - Syafarrel. All Right Reserved.</small>
        </div>
    </footer>
